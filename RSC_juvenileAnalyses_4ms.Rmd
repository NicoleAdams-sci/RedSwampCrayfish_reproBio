...
pedigree.plot(bc.ped.list$SHDco1.df, title="Hotel1_co1", cohortbox=F)
pedigree.plot(bc.ped.list$SHDco2.df, title="Hotel1_co2", cohortbox=F)
...
pedigree.plot(bc.ped.list$SHDcom.df, title="Hotel1_com", cohortbox=T) #save manually
